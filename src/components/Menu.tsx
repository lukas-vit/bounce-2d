  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black p-3 sm:p-8">
      <div className="text-center mb-3 sm:mb-6">
        <h1 className="text-3xl sm:text-6xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
          PING PONG
        </h1>
      </div>

      <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-2 sm:p-4 mb-3 sm:mb-6 shadow-lg max-w-md w-full">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <button
            ...
            className="flex items-center gap-1 sm:gap-2 text-gray-400 hover:text-cyan-400 transition-colors duration-300 
              hover:bg-gray-700 px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm"
          >
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-3 sm:p-8 shadow-2xl max-w-md w-full">
        <h2 className="text-lg sm:text-2xl font-semibold mb-3 sm:mb-6 text-center text-white">
          Select Difficulty
        </h2>
        ...
        <div className="space-y-2 sm:space-y-4 mb-4 sm:mb-8">
          {DIFFICULTIES.map((difficulty) => (
            <button
              ...
              className={`w-full p-2 sm:p-4 rounded-xl transition-all duration-300 border-2 border-gray-600 hover:border-cyan-400 
        ...
        <button
          ...
          className="w-full p-2 sm:p-4 rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 
        ...
        <div className="mt-3 sm:mt-6 p-2 sm:p-4 bg-gray-700/50 rounded-lg border border-gray-600">
      ...
      <div className="mt-4 sm:mt-8 text-center text-gray-500 px-3 sm:px-4">
